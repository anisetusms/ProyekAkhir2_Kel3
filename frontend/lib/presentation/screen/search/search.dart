    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextField(
          ...
          onTap: () => controller.selectItem.value = false,
      ...
      body: Obx(() => Padding(
            ...
            child: controller.selectItem.value == false
                ? Column(
                    ...
                    children: [
                      // Lokasi Sekitar Bisa Diklik
                      InkWell(
                        onTap: () {
                          Get.to(() => const NearbyResultPage());
                        },
                        child: Row(
                          children: const [
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        SearchControllers.searchText[index],
