part of 'home_owner_import.dart';

class HomeOwner extends StatefulWidget {
  const HomeOwner({super.key});

  @override
  State<HomeOwner> createState() => _HomeState();
}

class _HomeState extends State<HomeOwner> {

  late HomeOwnerController controller = controller = Get.put(HomeOwnerController());
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Hello, Pemilik 👋", style: TextStyle(color: controller.themeController.isDarkMode.value ? MyColors.white : MyColors.successColor, fontWeight: FontWeight.w700, fontSize: 26)),
