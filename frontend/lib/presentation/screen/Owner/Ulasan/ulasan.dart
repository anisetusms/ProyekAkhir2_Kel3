part of 'ulasan_import.dart';

class Ulasan extends StatefulWidget {
  final String? status;
  const Ulasan({super.key, this.status});
...
class _UlasanState extends State<Ulasan> {
  ...
  late UlasanControllers controller;

  @override
  void initState() {
    controller = Get.put(UlasanControllers());
    super.initState();
  }
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                itemCount: UlasanControllers.searchText.length,
                  ...
                  return Column(
                    children: [
                      InkWell(
                        ...
                        child: Row(
                          children: [
                            Text(UlasanControllers.searchText[index], style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 18),),
                            const Spacer(),
                            InkWell(
                              onTap: () {
