part of 'booking_owner_import.dart';

class BookingOwner extends StatefulWidget {
  const BookingOwner({super.key});

  @override
  State<BookingOwner> createState() => _BookingState();
}

class _BookingState extends State<BookingOwner> with SingleTickerProviderStateMixin {
  late BookingOwnerController controller = Get.put(BookingOwnerController());
