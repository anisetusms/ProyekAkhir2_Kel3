              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    loginOption(context, MyImages.facebook,
                        MyString.facebookTitle, controller.themeController.isDarkMode.value),
                    const SizedBox(height: 20),
                    loginOption(context, MyImages.google,
                        MyString.googleTitle, controller.themeController.isDarkMode.value),
                    const SizedBox(height: 20),
                    Container(
                      height: 55,
...
Widget loginOption(
    BuildContext context, String image, String title, bool isDarkMode) {
  return Container(
    height: 55,
    width: MediaQuery.of(context).size.width,
    decoration: BoxDecoration(
      borderRadius: BorderRadius.circular(15),
      border: Border.all(
          color: isDarkMode ? MyColors.dividerDarkTheme : MyColors.dividerLightTheme),
    ),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
