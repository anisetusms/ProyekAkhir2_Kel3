...
Route::prefix('super-admin')->name('super_admin.')->group(function () {
    ...
    Route::get('/profiles/edit', [SuperAdminController::class, 'editProfile'])->name('profiles.edit');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    // Booking routes
    Route::prefix('properties/bookings')->name('properties.bookings.')->group(function () {
        Route::get('/', [OwnerBookingController::class, 'index'])->name('index');
        Route::get('/dashboard', [OwnerBookingController::class, 'index'])->name('dashboard');
        Route::get('/statistics', [OwnerBookingController::class, 'statistics'])->name('statistics');
        Route::get('/pending', [OwnerBookingController::class, 'getPendingBookings'])->name('pending');
        Route::get('/notifications/count', [OwnerBookingController::class, 'getUnreadNotificationsCount'])->name('notifications.count');
        Route::get('/{id}', [OwnerBookingController::class, 'show'])->name('show');
        Route::post('/{id}/confirm', [OwnerBookingController::class, 'confirm'])->name('confirm');
        Route::post('/{id}/reject', [OwnerBookingController::class, 'reject'])->name('reject');
        Route::post('/{id}/complete', [OwnerBookingController::class, 'complete'])->name('complete');
    });
