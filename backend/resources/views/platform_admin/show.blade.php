            ...
            <div class="card shadow-lg">
                <div class="card-header bg-gradient-primary text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('platform_admin.pengusaha') }}" class="btn btn-sm btn-light shadow-sm">
                            ...
                            <tbody>
                                @foreach($properties as $property)
                                    <tr>
                                        ...
                                        <a href="{{ route('platform_admin.properties.details', $property->id) }}" class="btn btn-sm btn-outline-info" data-bs-toggle="tooltip" title="Detail Property">
