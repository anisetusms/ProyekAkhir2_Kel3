    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('super_admin.entrepreneurs.approved') }}" class="btn btn-secondary">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    @if($property->image)
                        <img src="{{ $property->image_url }}" alt="Properti Image" class="img-thumbnail" style="width: 100%;">
                    @else
