...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/images/logoHommie.jpg')); ?>" type="image/png">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('admin.properties.dashboard')); ?>">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?php echo e(request()->routeIs('admin.properties.dashboard') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('admin.properties.dashboard')); ?>">
            ...
            <!-- Nav Item - Properties -->
            <li class="nav-item <?php echo e(request()->routeIs('admin.properties.index') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('admin.properties.index')); ?>">
            ...
            <!-- Nav Item - Bookings -->
            <li class="nav-item <?php echo e(request()->routeIs('admin.properties.bookings.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('admin.properties.bookings.dashboard')); ?>">
                    <i class="fas fa-fw fa-calendar-check"></i>
                    <span>Pemesanan</span>
                </a>
            </li>

            <li class="nav-item <?php echo e(request()->routeIs('admin.properties.ulasan.*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('admin.properties.ulasan.dashboard')); ?>">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item - Bookings -->
                        <li class="nav-item <?php echo e(request()->routeIs('admin.bookings.*') ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('admin.properties.bookings.dashboard')); ?>">
                                <i class="fas fa-fw fa-calendar-check"></i>
                                <span>Pemesanan</span>
                            </a>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="<?php echo e(route('admin.properties.bookings.dashboard')); ?>">Lihat Semua Notifikasi</a>
                            </div>
                        </li>

                        <script>
                            // Memuat pemesanan yang sedang berlangsung
                            fetch("<?php echo e(route('admin.properties.bookings.pending')); ?>") // Fixed route URL
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('admin.properties.bookings.show', '')); ?>/${booking.id}">
                        <div class="mr-3">
...
</html><?php /**PATH E:\KULIAH\SEMESTER 4\PA2\ProyekAkhir2\backend\resources\views/layouts/admin.blade.php ENDPATH**/ ?>