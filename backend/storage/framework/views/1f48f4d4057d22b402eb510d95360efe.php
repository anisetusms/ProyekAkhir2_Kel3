  ...
  <header class="top-header" id="Parent_Scroll_Div">
    <nav class="navbar navbar-expand-xl align-items-center gap-3 container px-4 px-lg-0">
      ...
      <div class="">
        ...
        <!-- Tombol Login -->
        <a href="<?php echo e(route('showLoginForm')); ?>" class="btn btn-grd btn-grd-success raised d-flex align-items-center rounded-5 gap-2 px-4">
          ...
          <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
            <a class="dropdown-item gap-2 py-2" href="javascript:;">
              <div class="text-center">
                <img src="<?php echo e(Auth::user()->profile_picture ? asset('storage/profile_pictures/' . Auth::user()->profile_picture) : asset('img/undraw_profile.svg')); ?>"
...
</html><?php /**PATH E:\KULIAH\SEMESTER 4\PA2\ProyekAkhir2\backend\resources\views/layouts/index-welcome.blade.php ENDPATH**/ ?>