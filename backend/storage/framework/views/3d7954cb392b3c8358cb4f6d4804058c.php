            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <h6>Jenis Ruangan</h6>
                            <p><?php echo e($room->room_type); ?></p>
                        </div>
                        <div class="col-md-6">
                            <h6>Nomor Ruangan</h6>
                            <p><?php echo e($room->room_number); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p>Rp <?php echo e(number_format($room->price, 0, ',', '.')); ?></p>
                        </div>
                        <div class="col-md-6">
                            <h6>Ukuran</h6>
                            <p><?php echo e($room->size ? $room->size . ' m²' : '-'); ?></p>
                        </div>
                    </div>
                    ...
                    <?php if($room->facilities && count($room->facilities) > 0): ?>
                        <ul class="list-group">
                            <?php $__currentLoopData = $room->facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item"><?php echo e($facility->facility_name); ?></li>
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body d-grid gap-2">
                    <a href="<?php echo e(route('admin.properties.rooms.edit', [$property->id, $room->id])); ?>" 
                       class="btn btn-primary btn-block">
                        <i class="fas fa-edit me-1"></i> Edit Ruangan
                    </a>
                    <form action="<?php echo e(route('admin.properties.rooms.destroy', [$property->id, $room->id])); ?>" method="POST" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\KULIAH\SEMESTER 4\PA2\ProyekAkhir2\backend\resources\views/admin/properties/rooms/show.blade.php ENDPATH**/ ?>