  ...
  Widget _buildKostDetails(dynamic property) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        _buildDetailRow('Makan Termasuk:', 
          (kostDetail['meal_included'] == 1 || kostDetail['meal_included'] == true) ? 'Ya' : 'Tidak'),
        _buildDetailRow('Laundry Termasuk:', 
          (kostDetail['laundry_included'] == 1 || kostDetail['laundry_included'] == true) ? 'Ya' : 'Tidak'),
        SizedBox(height: 8.0),
